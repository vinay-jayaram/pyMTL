...
from pymtl.mtl_linear_regression import BayesRegression
from pymtl.mtl_logistic_regression import BayesLogisticRegression

__author__ = "Karl-Heinz Fiebig"
__copyright__ = "Copyright 2017"


class FeatureDecompositionModel(BayesPriorTL):
    """
    TODO
    """
    ...
    def fit(self, features, targets):
        ...
        self.spectral_model.set_params(lam=self.lam)
    ...
    def loss(self, features, targets):
        ...
        """
        # Setup current parameters
        self.spatial_model.lam = self.lam
        self.spectral_model.lam = self.lam
